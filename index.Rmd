...
This transition allows you to let data gradually appear. We will show an example of building up the data over harvest dates in the `garden_harvest` dataset.  We will follow the steps outlined earlier for creating an animated plot.
